...
const operationsDoc = `query Spotifoo($query: String = "Ataraxia") @netlify(id: """e5097973-c979-4dbd-b0c1-a0d49047fb33""", doc: """An example query to start with.""") {
  spotify {
...
export const fetchSpotifoo = (variables, options) => {
  return fetchNetlifyGraph({
    query: operationsDoc,
    operationName: "Spotifoo",
    variables: variables,
    options: options || {},
  });
};
